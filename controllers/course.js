...
export const paymentVerification =TryCatch(async(req,res)=>{
    ...
    const expectesSignature =crypto.createHmac("sha256",process.env.Razorpay_Secret).update(body).digest("hex");

    const isAuthentic = expectesSignature === razorpay_signature;
